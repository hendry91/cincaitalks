define(['directives/directives', 'moment'],
    function (directives, moment) {
        directives.directive('lovewall', ['deploydService', '$compile', '$rootScope', 'itemPerPage', 'authServices', function (deploydService, $compile, $rootScope, itemPerPage, authServices) {

            function tableCtrl($scope, $element) {
                $rootScope.breakLineTitle = "Love Story";
