define(['directives/directives', 'moment'],
    function (directives, moment) {
        directives.directive('otherwall', ['deploydService', '$compile', '$rootScope', 'itemPerPage', 'authServices', function (deploydService, $compile, $rootScope, itemPerPage, authServices) {

            function tableCtrl($scope, $element) {
                $rootScope.breakLineTitle = "Other";
